...
def main():
    ...
    f_Analytical = Analytical.Analytical_Periodic ( f_0 , c, Nt, gridx.length , 0 )
    
    # Call CTBS method with periodic boundaries   
    f_CTBS = CTBSAlone.CTBS ( f_0 , c , Nt ,gridx.length , 0  )
    
    # Call CTCS method with periodic boundaries    
    f_CTCS = CTCSAlone.CTCS ( f_0 , c, Nt, gridx.length , 0  )
    
    # Call CTBS method with periodic boundaries   
    f_FTCS = FTCSAlone.FTCS ( f_0 , c, Nt , gridx.length , 0  )
    ...
    # Call Analytical solution with periodic boundaries
    u_Analytical = Analytical.Analytical_Periodic ( u_0 , c, Nt, gridx.length, 0 )
    
    # Call CTBS method with periodic boundaries   
    u_CTBS = CTBSAlone.CTBS ( u_0 , c , Nt ,gridx.length , 0  )
    
    # Call CTCS method with periodic boundaries    
    u_CTCS = CTCSAlone.CTCS ( u_0 , c, Nt ,gridx.length , 0  )
    
    # Call CTBS method with periodic boundaries   
    u_FTCS = FTCSAlone.FTCS ( u_0 , c, Nt ,gridx.length , 0  )
