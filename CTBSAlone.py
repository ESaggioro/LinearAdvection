...
# This function implements CTBS scheme with periodic boundaries on the linear 
# advection eq.
...
def CTBS ( phi0, c , nt , Length, plotting=0): 
    ...
    phiOld1[nx-1] = phiOld1[0]
        ...
        # Loop over time steps t = 1,..nt
    for it in range(1,nt):  # it= 1,.., nt-1 (total of nt-2 elements)
